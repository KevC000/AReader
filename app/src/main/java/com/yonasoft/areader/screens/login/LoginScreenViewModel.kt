package com.yonasoft.areader.screens.login
...
import com.yonasoft.areader.model.MUser
...
class LoginScreenViewModel @Inject constructor() : ViewModel() {
    ...
    private fun createUser(displayName: String?){
        ...
        val user = MUser(userId = userId.toString(), displayName = displayName.toString(), avatarUrl = "", quote = "Life is reat", profession = "Android Developer", id = null).toMap()
